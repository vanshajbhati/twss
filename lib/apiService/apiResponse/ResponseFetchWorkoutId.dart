class ResponseFetchWorkoutCategoryId {
  int errorCode;
  String reponseString;
  List<Data> data;

  ResponseFetchWorkoutCategoryId(
      {this.errorCode, this.reponseString, this.data});

  ResponseFetchWorkoutCategoryId.fromJson(Map<String, dynamic> json) {
