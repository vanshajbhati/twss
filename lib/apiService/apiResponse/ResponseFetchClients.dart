class ResponseFetchCleints {
  int errorCode;
  String reponseString;
  List<DataFetchClients> data;

  ResponseFetchCleints({this.errorCode, this.reponseString, this.data});

  ResponseFetchCleints.fromJson(Map<String, dynamic> json) {
    errorCode = json['error_code'];
    reponseString = json['reponse_string'];
    if (json['data'] != null) {
      data = new List<DataFetchClients>();
      json['data'].forEach((v) {
        data.add(new DataFetchClients.fromJson(v));
      });
    }
  }
...
class DataFetchClients {
  ...
  DataFetchClients.fromJson(Map<String, dynamic> json) {
    id = json['id'];
