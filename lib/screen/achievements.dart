...
class _AchivementsState extends State<Achivements> {
  ...
  void _trySubmit()async{
    ...
    await Provider.of<ApiManager>(context,listen: false).newCertificateApi(filename, dropdownValue, "static Organisation", descriptionController.text);
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text("Add New Certificate", style: TextStyle(
